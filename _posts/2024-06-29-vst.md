...
A more simpler version of this patch was used in the interactive element of my website in the homepage. Insteasd of sending the notes into the Vital (instrument), I designed a very simple synthesiser into the patch and then sent the signal into my Doom Fuzz patch, Exposing just the Doom and Fuzz params to change with cursor position. 
