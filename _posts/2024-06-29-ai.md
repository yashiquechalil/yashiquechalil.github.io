...
<p>Running isolated bass and drums of John Coltrane's Giant Steps, pitched down into PlantModel v1. </p>
</div>
...
<p>Halucinations (The sounds that the model makes when there is no input going in) of the Plant Model V2. The variations were performed by manipulating the Latent Variables of the trained nueral network.</p>
</div>
...
<p>Creating grass footstep sounds with the Plant Model v2.</p>
</div>
